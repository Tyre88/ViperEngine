...
namespace ViperEngine.GameObjects
{
    public class Player
    {
        ...
        List<Texture2D> bodyList;
        System.TimeSpan lastUpdate;
        ...
        private void Init(Dificulty dificulty)
        {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            {
                //if (rotation[0] != newRotation)
                //{
                //    origin[0] = new Vector2(4, 4);
                //}
                ...
                for (int i = 0; i < position.Count; i++)
                {
                    ...
                    //if (i == 1)
                    //{
                    //    if (rotation[i - 1] == -(float)Math.PI / 2.0f && rotation[i + 1] == 0)
                    //    {
                    //        rotation[i] = (-(float)Math.PI / 2.0f) / 2;
                    //        origin[i] = new Vector2(4, 4);
                    //    }
                    //}
                    //else
                    //{
